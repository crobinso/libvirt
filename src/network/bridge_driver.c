...
static virNetworkDriver networkDriver = {
    ...
    .networkPortLookupByUUID = networkPortLookupByUUID, /* 5.2.0 */
    .networkPortCreateXML = networkPortCreateXML, /* 5.2.0 */
    .networkPortGetXMLDesc = networkPortGetXMLDesc, /* 5.2.0 */
    .networkPortDelete = networkPortDelete, /* 5.2.0 */
    .networkListAllPorts = networkListAllPorts, /* 5.2.0 */
    .networkPortGetParameters = networkPortGetParameters, /* 5.2.0 */
    .networkPortSetParameters = networkPortSetParameters, /* 5.2.0 */
};
